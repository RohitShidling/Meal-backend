...
const initDB = async () => {
  ...
  try {
    ...
    await pool.query(`ALTER TABLE IF EXISTS orders ADD COLUMN IF NOT EXISTS payment_finalized_at TIMESTAMPTZ;`);
    await pool.query(`ALTER TABLE IF EXISTS orders ADD COLUMN IF NOT EXISTS payment_finalized_source VARCHAR(30);`);
